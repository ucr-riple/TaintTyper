 ...
 */
public class UCRTaintingSanitizationTest extends CheckerFrameworkPerDirectoryTest {
  public UCRTaintingSanitizationTest(List<File> testFiles) {
    super(
        testFiles,
